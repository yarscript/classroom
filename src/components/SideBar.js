...
export default function SideBar() {
    return (
        <div className="sidebar-wrapper w-[270px]  ml-[40px]  px-[12px] pt-[12px] pb-[4px] rounded-[20px]">
            <div className='bg-[#203854] mb-4 rounded-[8px]  text-center flex flex-col items-center py-[24px] px-[10px]'>
